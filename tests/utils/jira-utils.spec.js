  ...
  it('should apply markdown to strong text', () => {
    const description = {
      content: [
        {
          type: 'paragraph',
          content: [{ text: 'Bold', marks: [{ type: 'strong' }] }, { text: ' and normal text.' }]
        }
      ]
    }
    ...
    const tickets = [
      {
        ...
        ticketNumber: 'A-1',
        summary: 'Ticket A1',
        copyAIDescription: 'Description A1',
      ...
      },
      {
        ...
        ticketNumber: 'B-1',
        summary: 'Ticket B1',
        copyAIDescription: 'Description B1',
      ...
      },
      {
        ...
        ticketNumber: 'C-1',
        summary: 'Ticket C1',
        copyAIDescription: 'Description C1',
        isCustomerFacing: true
      },
      {
        team: 'TeamA',
        ticketNumber: 'A-2',
        summary: 'Ticket A2',
        copyAIDescription: 'Description A2',
        isCustomerFacing: false
      }
    ]
  ...
  it('should handle tickets with teams not listed in the environment configuration', () => {
    ...
    const tickets = [
      ...
      },
      {
        ...
        ticketNumber: 'X-1',
        summary: 'Ticket X1',
        copyAIDescription: 'Description X1',
        isCustomerFacing: false
      }
    ]
