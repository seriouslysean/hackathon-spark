      ...
      tickets: [
        {
          ...
          summary:
            'Investigate and address the recent yeast shortage impacting bread production rates.',
          customerFacing: true
        },
        {
          ticket: 'BB-124',
      ...
      tickets: [
        {
          ...
          summary:
            'Resolve temperature fluctuations in the cheese aging rooms to ensure product consistency.',
        ...
        },
        {
          ...
          summary:
            'Research and develop lactose-free cheese options to cater to lactose-intolerant customers.',
          customerFacing: true
        }
      ]
    },
      ...
      tickets: [
        {
          ...
          summary:
            'Develop a contingency plan for cocoa supply chain disruptions to maintain production schedules.',
          customerFacing: false
        },
        {
          ticket: 'CA-790',
          ...
          summary:
            'Launch a new line of organic chocolates to meet growing consumer demand for organic products.',
          customerFacing: true
        }
      ]
    },
      ...
      tickets: [
        {
          ...
          summary:
            'Create a new gluten-free pasta recipe to expand our product line to include gluten-sensitive options.',
          customerFacing: true
        }
      ]
    },
      ...
      tickets: [
        {
          ...
          summary:
            'Expand our dessert offerings with new vegan options to cater to a broader customer base.',
          customerFacing: true
        },
        {
          ticket: 'PC-113',
          ...
          summary:
            'Develop reduced sugar recipes for our existing dessert lineup to offer healthier options.',
          customerFacing: true
        },
        {
          ticket: 'PC-114',
          ...
          summary:
            'Implement eco-friendly packaging for all pastry products to reduce environmental impact.',
          customerFacing: false
        }
      ]
    }
